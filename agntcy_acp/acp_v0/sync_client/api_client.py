...
class ApiClient:
    ...
    def authorize(
        ...
        """Authorizes the request with the PDP server.
        ...
        try:
            ...
            if response.status_code != 200:
                raise ApiException(
                    ...
                    reason=f"Authorization failed: {response.text}"
                )
    ...
    def call_api(
        ...
        """Makes the HTTP request (synchronous) and optionally applies authorization
