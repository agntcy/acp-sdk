...
from acp_sdk.v0.models.agent_manifest import AgentManifest
...
class AgentsApi:
    ...
    @validate_call
    async def get_agent_manifest_by_id(
        self,
        agent_id: Annotated[StrictStr, Field(description="The ID of the agent.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_agent_manifest_by_id_serialize(
            agent_id=agent_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_agent_manifest_by_id_with_http_info(
        self,
        agent_id: Annotated[StrictStr, Field(description="The ID of the agent.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_agent_manifest_by_id_without_preload_content(
        self,
        agent_id: Annotated[StrictStr, Field(description="The ID of the agent.")],
        _request_timeout: Union[
            None,
    ...
    def _get_agent_manifest_by_id_serialize(
        self,
        agent_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/agents/{agent_id}/manifest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
