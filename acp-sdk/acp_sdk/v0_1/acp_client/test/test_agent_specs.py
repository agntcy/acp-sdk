...
class TestAgentSpecs(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AgentSpecs:
        """Test AgentSpecs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgentSpecs`
        """
        model = AgentSpecs()
        if include_optional:
            return AgentSpecs(
