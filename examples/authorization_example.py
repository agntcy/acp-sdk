...
"""
Example script demonstrating how to use authorization with the ACP SDK.

This example shows how to:
1. Configure the client with authorization settings
...
def main():
    ...
    try:
        # Make an API call with authorization parameters
